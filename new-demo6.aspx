<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new-demo6.aspx.cs" Inherits="new_demo6" %>
...
<title>Final Flow Diagram</title>
...
<!-- RIGHT COLUMN -->
<asp:Label ID="b1" runat="server" Text="Box1" CssClass="box" Style="left:24vw; top:8vh;" />
<asp:Label ID="b2" runat="server" Text="Box2" CssClass="box" Style="left:24vw; top:16vh;" />
<asp:Label ID="b3" runat="server" Text="Box3" CssClass="box" Style="left:24vw; top:24vh;" />
<asp:Label ID="b4" runat="server" Text="Box4" CssClass="box" Style="left:24vw; top:32vh;" />
<asp:Label ID="b5" runat="server" Text="Box5" CssClass="box" Style="left:24vw; top:40vh;" />
<asp:Label ID="b6" runat="server" Text="Box6" CssClass="box" Style="left:24vw; top:48vh;" />
<asp:Label ID="b7" runat="server" Text="Box7" CssClass="box" Style="left:24vw; top:56vh;" />
...
<!-- FORK OUTPUT -->
<asp:Label ID="b201_1" runat="server" Text="201-1"
    CssClass="box" Style="left:58vw; top:15vh;" />

<asp:Label ID="b201_2" runat="server" Text="201-2"
    CssClass="box" Style="left:58vw; top:22vh;" />

    <asp:Label ID="b201_21" runat="server" Text="201-21"
    CssClass="box" Style="left:66vw; top:22vh;" />
...
let B2 = box("b2");
let B201 = box("b201");
let B201_1 = box("b201_1");
let B201_2 = box("b201_2");
let B201_21 = box("b201_21");

// Box2 → 201
arrow(B2.x+B2.w, B2.y+B2.h/2,
      B201.x, B201.y+B201.h/2);


arrow(B201_2.x+B201_2.w, B201_2.y+B201_2.h/2,
      b201_21.x, B201_21.y+B201_21.h/2);

// 201 → fork point
let forkX = B201.x + B201.w + 20;
let forkY = B201.y + B201.h/2;

// line to fork
ctx.beginPath();
ctx.moveTo(B201.x + B201.w, B201.y + B201.h/2);
ctx.lineTo(forkX, forkY);
ctx.stroke();

// fork branches
arrow(forkX, forkY,
      B201_1.x, B201_1.y + B201_1.h/2);

arrow(forkX, forkY,
      B201_2.x, B201_2.y + B201_2.h/2);
